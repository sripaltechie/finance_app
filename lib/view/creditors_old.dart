...
//   // void _showPopupDialog(BuildContext context, msg) {
//   //   showDialog(
//   //     context: context,
...
//         {"forint": "1", "sort_by": "a.firstname", "sort_order": "asc"});
...
//     return ChangeNotifierProvider<CreditorsListViewModel>(
//       create: (BuildContext context) => creditorsListViewModel,
//       child: Consumer<CreditorsListViewModel>(
...
//                             _sort((d) => d["customer"], columnIndex, ascending);
//                           },
//                         ),
//                         DataColumn(
...
//                           onSort: (columnIndex, ascending) {
//                             _sort((d) => d["intrate"], columnIndex, ascending);
//                           },
//                         ),
//                         DataColumn(
//                           label: Text('Amount'),
//                           onSort: (columnIndex, ascending) {
//                             _sort((d) => d["amount"], columnIndex, ascending);
//                           },
//                         ),
//                         DataColumn(
//                           label: Text('Interest'),
//                           onSort: (columnIndex, ascending) {
//                             _sort((d) => d["interest"], columnIndex, ascending);
//                           },
//                         ),
//                       ],
